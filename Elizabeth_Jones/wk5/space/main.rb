...
get '/dishes/new' do  #shows the form only
  erb :trips_new
end


post '/dishes' do  #creates the dish only
    db = PG.connect(dbname: 'travel')
...
get '/dishes/:id' do      # can put /dishes/whateveryouwant and you will see 'hi im a cake'
  #show single dish -  search for dish with that id
